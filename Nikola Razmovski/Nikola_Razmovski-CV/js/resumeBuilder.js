...
var work = {
...

		{
			...
			"employer" : "Tank & Rast",
			"title" : "Cleaner",
			"dates" : "15/06/2016 - 15/09/2016 in",
		...
		},
		{
			...
			"employer" : "Cermat",
			"title" : "Worker",
			"dates" : "30/06/2016 - 15/08/2016 in",
...
for (job in work.jobs){
	...
	//$("#header").append(HTMLbreak);
	var formmatedLocaton = HTMLworkLocation.replace("%data%" , work.jobs[job].location);
	$(".work-entry:last").append(formmatedLocaton);
...
var line1 = HTMLline.replace ("data" , line);


$("#lets-connect").append(line1);
